...
<section class="wrapper">
    <div class="container">
        <div id="scene" class="scene" data-hover-only="false">
            ...
            <p class="p404 text-center" data-depth="0.50">Starts Soon !</p>
            <p class="p404 text-center" data-depth="0.10">Starts Soon !</p>
        </div>

        <div class="text">
            <article>
                <p>
                    Il sembleraiat que votre jeu,
                    <br /> soit en cours de preparation
                    <br /> il sera bientot disponible.
                </p>
                <a href="https://swapye.com" target="_blank">
                    <button>Swapye</button>
                </a>
            </article>
        </div>
    </div>
